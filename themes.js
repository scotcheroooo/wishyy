...
function buildThemeDialog() {
  ...
  dialog.innerHTML = `
    ...
    <div class="theme-font-toggle-row">
      <span class="theme-font-toggle-label">Lock font to selected theme</span>
      <label class="font-pill-toggle" aria-label="Lock font to theme">
        <input type="checkbox" id="fontFixToggle" ${isLocked ? 'checked' : ''}>
        <span class="font-pill-track"><span class="font-pill-thumb"></span></span>
      </label>
    </div>
